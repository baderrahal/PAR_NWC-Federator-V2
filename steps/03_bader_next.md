...
242. Look for, F59: `STEP       HARVEST` and `STEP       IMAGES` are indented two spaces further than the others. They run inside the clash step, and the indent is how the log says so
