...
namespace Federator.Core.Clash
{
    ...
    /// 2026-08-30 and recorded in docs\history\scan.md. They are repeated here because Core never
    /// references the Navisworks API, exactly as ConditionTest does for the sets.
    ///
    /// A test type that is not one of these is reported by name and skipped, never
    /// approximated to the nearest one. The reason is in .claude\rules\core.md.
    /// </summary>
